...
const reducerName = "medicationsSetupReducer";
const rowKey = "idValue";

// Fetch initial data
export const fetchData = (sorter, filters) => ({
  type: FETCH_MEDICATIONS_SETUP_DATA,
  reducerName,
  API_URL: "medication",
  sorter,
  filters,
...
export const fetchDataFinished = (result, isSorted, isFiltered) => ({
  type: FETCH_MEDICATIONS_SETUP_DATA_FINISHED,
...
export const requestInsertRecord = (recordData) => ({
  type: ON_REQUEST_INSERT_MEDICATIONS_SETUP_RECORD,
  recordData,
  rowKey,
  reducerName,
  API_URL: "medication",
...
export const resetColValue = () => ({
  type: ON_RESET_LAST_COLUMN_LANGUAGE_MEDICATIONS_SETUP,
});
